...
from ttsflow.ttsflow import TTSFlow
...
def get_args_parser():
    ...
    parser.add_argument('--val_dataset', default=['chairs','sintel'], type=str, nargs='+',
                        help='validation dataset')
    parser.add_argument('--with_speed_metric', action='store_true',
                        help='with speed metric when evaluation')
    parser.add_argument('--dino_path',default="facebook/dinov2-small",type=str,
                        help="path of Dino V2(S) to use as a feature backbone")
    parser.add_argument('--depth_model_path',default="depth_anything_v2_ckpt.pth",type=str,
                        help="path of Depth Anything V2(B) to use as a depth decoder")
    ...
    parser.add_argument('--val_freq', default=20000, type=int)
    parser.add_argument('--save_ckpt_freq', default=50000, type=int)
    parser.add_argument('--save_latest_ckpt_freq', default=50000, type=int)
    ...
    parser.add_argument('--num_scales', default=1, type=int,
                        help='basic ttsflow model uses a single 1/8 feature, the refinement uses 1/4 feature')
...
def main(args):
    ...
    # model
    model = TTSFlow(feature_channels=args.feature_channels,
    ...
    while total_steps < args.num_steps:
        ...
        for i, sample in enumerate(train_loader):
            ...
            # print("This is step:",total_steps)
