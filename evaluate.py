...
from ttsflow.geometry import forward_backward_consistency_check
...
def validate_chairs(model,
    ...
    for val_id in range(len(val_dataset)):
        ...
        print(f"Validating Flying chairs image number:{val_id}")
...
def validate_things(model,
    ...
    for dstype in ['frames_cleanpass', 'frames_finalpass']:
        ...
        for val_id in range(len(val_dataset)):
            ...
            print(f"Validating Flying Things 3d image number:{val_id}")
...
def validate_sintel(model,
    ...
    for dstype in ['clean', 'final']:
        ...
        for val_id in range(len(val_dataset)):
            ...
            print(f"Validating Sintel image number:{val_id}")
    ...
    for test_id in range(0, len(filenames) - 1, stride):
        ...
        if inference_size is None:
            ...
            if torch.cuda.is_available():
                ...
                image1, image2 = padder.pad(image1[None].cpu(), image2[None].cpu())    
        else:
